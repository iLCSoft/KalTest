...
ClassImp(EXRKEventGen)

Double_t EXRKEventGen::fgT0 = 0.; // [nsec]

TRKTrack EXRKEventGen::GenerateRKTrack(Double_t chg, TVector3 x, TVector3 p)
{
   // Create a Runge-Kutta track
   TRKTrack rkTrack(chg, x, p);

   return rkTrack;
}

void EXRKEventGen::Swim(TRKTrack &rktrk, Double_t mass)
{
   // ---------------------------
